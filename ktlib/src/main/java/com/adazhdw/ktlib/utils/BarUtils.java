...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (KtLib.INSTANCE.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, KtLib.INSTANCE.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = KtLib.INSTANCE.getApp().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = KtLib.INSTANCE.getApp()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) KtLib.INSTANCE.getApp().getSystemService(Context.WINDOW_SERVICE);
            if (wm == null) {
                return false;
            }
        ...
        boolean menu = ViewConfiguration.get(KtLib.INSTANCE.getApp()).hasPermanentMenuKey();
