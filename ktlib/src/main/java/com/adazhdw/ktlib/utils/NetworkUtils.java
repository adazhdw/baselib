...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        KtLib.INSTANCE.getApp().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) KtLib.INSTANCE.getApp().getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) {
                return false;
            }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) KtLib.INSTANCE.getApp().getSystemService(WIFI_SERVICE);
        if (manager == null) {
            return false;
        }
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) KtLib.INSTANCE.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
            return false;
        }
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) KtLib.INSTANCE.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) {
            return "";
        }
