...
fun android.view.View.onAttachStateChangeListener(
    ...
    val listener =
        __View_OnAttachStateChangeListener(context)
    listener.init()
    addOnAttachStateChangeListener(listener)
}

class __View_OnAttachStateChangeListener(private val context: CoroutineContext) :
    android.view.View.OnAttachStateChangeListener {

    private var _onViewAttachedToWindow: (suspend CoroutineScope.(android.view.View) -> Unit)? =
        null
    ...
    private var _onViewDetachedFromWindow: (suspend CoroutineScope.(android.view.View) -> Unit)? =
        null
...
fun android.gesture.GestureOverlayView.onGestureListener(
    ...
    val listener =
        __GestureOverlayView_OnGestureListener(
            context
        )
    listener.init()
...
class __GestureOverlayView_OnGestureListener(private val context: CoroutineContext) :
    android.gesture.GestureOverlayView.OnGestureListener {

    private var _onGestureStarted: (suspend CoroutineScope.(android.gesture.GestureOverlayView?, android.view.MotionEvent?) -> Unit)? =
        null


    override fun onGestureStarted(
        overlay: android.gesture.GestureOverlayView?,
    ...
    private var _onGesture: (suspend CoroutineScope.(android.gesture.GestureOverlayView?, android.view.MotionEvent?) -> Unit)? =
        null
    ...
    private var _onGestureEnded: (suspend CoroutineScope.(android.gesture.GestureOverlayView?, android.view.MotionEvent?) -> Unit)? =
        null
    ...
    private var _onGestureCancelled: (suspend CoroutineScope.(android.gesture.GestureOverlayView?, android.view.MotionEvent?) -> Unit)? =
        null
...
fun android.gesture.GestureOverlayView.onGesturingListener(
    ...
    val listener =
        __GestureOverlayView_OnGesturingListener(
            context
        )
    listener.init()
...
class __GestureOverlayView_OnGesturingListener(private val context: CoroutineContext) :
    android.gesture.GestureOverlayView.OnGesturingListener {

    private var _onGesturingStarted: (suspend CoroutineScope.(android.gesture.GestureOverlayView?) -> Unit)? =
        null
    ...
    private var _onGesturingEnded: (suspend CoroutineScope.(android.gesture.GestureOverlayView?) -> Unit)? =
        null
...
fun android.view.ViewGroup.onHierarchyChangeListener(
    ...
    val listener =
        __ViewGroup_OnHierarchyChangeListener(
            context
        )
    listener.init()
...
class __ViewGroup_OnHierarchyChangeListener(private val context: CoroutineContext) :
    android.view.ViewGroup.OnHierarchyChangeListener {

    private var _onChildViewAdded: (suspend CoroutineScope.(android.view.View?, android.view.View?) -> Unit)? =
        null
    ...
    private var _onChildViewRemoved: (suspend CoroutineScope.(android.view.View?, android.view.View?) -> Unit)? =
        null
...
fun android.widget.AbsListView.onScrollListener(
    ...
    val listener =
        __AbsListView_OnScrollListener(context)
    listener.init()
    setOnScrollListener(listener)
}

class __AbsListView_OnScrollListener(private val context: CoroutineContext) :
    android.widget.AbsListView.OnScrollListener {

    private var _onScrollStateChanged: (suspend CoroutineScope.(android.widget.AbsListView?, Int) -> Unit)? =
        null
    ...
    private var _onScroll: (suspend CoroutineScope.(android.widget.AbsListView?, Int, Int, Int) -> Unit)? =
        null
...
fun android.widget.AdapterView<out android.widget.Adapter>.onItemSelectedListener(
    ...
    val listener =
        __AdapterView_OnItemSelectedListener(
            context
        )
    listener.init()
...
class __AdapterView_OnItemSelectedListener(private val context: CoroutineContext) :
    android.widget.AdapterView.OnItemSelectedListener {

    private var _onItemSelected: (suspend CoroutineScope.(android.widget.AdapterView<*>?, android.view.View?, Int, Long) -> Unit)? =
        null
    ...
    private var _onNothingSelected: (suspend CoroutineScope.(android.widget.AdapterView<*>?) -> Unit)? =
        null
...
fun android.widget.SearchView.onQueryTextListener(
    ...
    val listener =
        __SearchView_OnQueryTextListener(context)
    listener.init()
    setOnQueryTextListener(listener)
}

class __SearchView_OnQueryTextListener(private val context: CoroutineContext) :
...
fun android.widget.SearchView.onSuggestionListener(
    ...
    val listener =
        __SearchView_OnSuggestionListener(context)
    listener.init()
    setOnSuggestionListener(listener)
}

class __SearchView_OnSuggestionListener(private val context: CoroutineContext) :
...
fun android.widget.SeekBar.onSeekBarChangeListener(
    ...
    val listener =
        __SeekBar_OnSeekBarChangeListener(context)
    listener.init()
    setOnSeekBarChangeListener(listener)
}

class __SeekBar_OnSeekBarChangeListener(private val context: CoroutineContext) :
...
fun android.widget.SlidingDrawer.onDrawerScrollListener(
    ...
    val listener =
        __SlidingDrawer_OnDrawerScrollListener(
            context
        )
    listener.init()
...
class __SlidingDrawer_OnDrawerScrollListener(private val context: CoroutineContext) :
