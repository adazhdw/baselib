 ...
 */
abstract class ListFragmentExt<A : BaseRvAdapter<Any>> : BaseFragmentImpl(),
    ...
    private fun nextPage() {
        ...
        mHandler.postDelayed({
            onNextPage(currPage, object : LoadCallback() {
                ...
                override fun onSuccessLoad(list: List<Any>) {
                    if (list.isNotEmpty()) {
                        mListAdapter.mData = list as MutableList<Any>
                    } else {
    ...
    abstract inner class LoadCallback {
         ...
         * thi method must after [.onResult]，and between two method mustn't have [ListFragmentExt.nextPage] call
         */
        abstract fun onSuccessLoad(list: List<Any>)
    }
