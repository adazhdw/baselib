package com.adazhdw.ktlib.widget.page;
...
import static com.adazhdw.ktlib.widget.page.PagerConfig.Loge;
import static com.adazhdw.ktlib.widget.page.PagerConfig.Logi;

public class PagerGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    public static final int VERTICAL = 0;           // 垂直滚动
    public static final int HORIZONTAL = 1;         // 水平滚动
    private static final String TAG = PagerGridLayoutManager.class.getName();
    @OrientationType
